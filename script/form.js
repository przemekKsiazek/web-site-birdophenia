			...
			formValidator = {
				...
				errorMessage: function(input) {
					...
					if (input === this.fields.userName) {
						message = "Proszę wpisz swoje imię i nazwisko";
						//ELSE IF USEREMAIL HAS ERROR 
					} else if (input === this.fields.userEmail) {
						message = "Proszę wpisz swój adres e-mail";
				...
				submitForm: function() {
					...
					this.changeHeader("Wiadomość wysłana");
					//WAIT FOR ANIMATION TO FINISH
					setTimeout(this.changeHeader.bind(this, "Dziękuje za Twoją wiadomość"), 1200);
				},
